...
exports.getProjectById = exports.getProjectsByCourseId = exports.courseProjects = void 0;
exports.courseProjects = [
    {
        id: "python-1",
...
const getProjectsByCourseId = (courseId) => {
    return exports.courseProjects.filter(project => project.courseId === courseId).sort((a, b) => a.order - b.order);
};
exports.getProjectsByCourseId = getProjectsByCourseId;
const getProjectById = (id) => {
    return exports.courseProjects.find(project => project.id === id);
};
exports.getProjectById = getProjectById;
//# sourceMappingURL=courseProjects.js.map