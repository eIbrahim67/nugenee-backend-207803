...
exports.getCertificateById = exports.getAllCertificates = exports.studentCertificates = void 0;
exports.studentCertificates = [
    {
        id: 'cert-1',
...
const getAllCertificates = () => {
    return exports.studentCertificates.sort((a, b) => b.order - a.order);
};
exports.getAllCertificates = getAllCertificates;
const getCertificateById = (id) => {
    return exports.studentCertificates.find(cert => cert.id === id);
};
exports.getCertificateById = getCertificateById;
//# sourceMappingURL=studentCertificates.js.map