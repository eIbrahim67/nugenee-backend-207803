...
exports.getCoursesByCategory = exports.getCourseById = exports.courses = exports.COURSE_CATEGORIES = void 0;
...
exports.courses = [
    {
        ...
        description: "A fun and visual introduction to programming for kids using Scratch, focused on creativity, storytelling, and game design.",
        descriptionAr: "مقدمة ممتعة وبصرية في البرمجة للأطفال باستخدام سكراتش، مع التركيز على الإبداع، ورواية القصص، وتصميم الألعاب.",
        overview: "This course introduces children to programming concepts through interactive stories, animations, and games built with Scratch. Learners develop logical thinking, creativity, and confidence while coding in a safe and engaging environment.",
        overviewAr: "تُعرّف هذه الدورة الأطفال بمفاهيم البرمجة من خلال القصص التفاعلية، والرسوم المتحركة، والألعاب باستخدام سكراتش، مما يساعدهم على تنمية التفكير المنطقي والإبداع والثقة الرقمية.",
        level: "Beginner",
        levelAr: "مبتدئ",
        ...
        certification: "Certificate of Completion – Creative Coding for Kids",
        certificationAr: "شهادة إتمام – البرمجة الإبداعية للأطفال",
        targetAudience: [
            "Kids aged 7–12",
    ...
    },
    {
        ...
        description: "A hands-on robotics course that combines Arduino electronics with Scratch-based visual programming to help students design, build, and program interactive robotic systems.",
        descriptionAr: "دورة عملية في الروبوتات تجمع بين إلكترونيات أردوينو والبرمجة المرئية باستخدام سكراش لمساعدة الطلاب على تصميم وبناء وبرمجة أنظمة روبوتية تفاعلية.",
        overview: "Students learn robotics fundamentals through visual programming and electronics. The course focuses on sensors, actuators, control logic, and creative problem solving using Arduino and Scratch, culminating in a capstone robotics project.",
        overviewAr: "يتعلم الطلاب أساسيات الروبوتات من خلال البرمجة المرئية والإلكترونيات، مع التركيز على الحساسات والمشغلات والمنطق البرمجي وحل المشكلات الإبداعي، وينتهي المشروع بمشروع روبوت متكامل.",
        level: "Intermediate",
        levelAr: "متوسط",
        ...
        certification: "Certificate of Completion – Creative Robotics with Arduino & Scratch",
        certificationAr: "شهادة إتمام دورة – الروبوتات الإبداعية باستخدام أردوينو وسكراش",
        targetAudience: [
    ...
    },
    {
        ...
        description: "A practical introductory course designed to help learners understand computers, their components, software, and everyday usage. The course builds essential digital literacy and prepares students for further technical learning.",
        descriptionAr: "دورة تمهيدية عملية تهدف إلى مساعدة المتعلمين على فهم الحاسوب ومكوناته والبرمجيات وكيفية استخدامه في الحياة اليومية، وبناء مهارات الثقافة الرقمية الأساسية والاستعداد للتعلم التقني المتقدم.",
        overview: "This course introduces learners to computer fundamentals, including hardware, software, operating systems, file management, internet usage, digital communication, security, and productivity tools. It emphasizes hands-on practice and real-world computer usage.",
        overviewAr: "تقدم هذه الدورة أساسيات الحاسوب بما في ذلك المكونات المادية، البرمجيات، أنظمة التشغيل، إدارة الملفات، استخدام الإنترنت، التواصل الرقمي، الأمان، وأدوات الإنتاجية، مع التركيز على التطبيق العملي.",
        level: "Beginner",
        levelAr: "مبتدئ",
        duration: "30 Hours",
        durationAr: "30 ساعة",
    ...
    {
        id: "python-for-all",
        icon: lucide_react_1.Snail,
        title: "Python for All",
        titleAr: "بايثون للجميع",
        description: "The essential Python foundation course for all students. Covers programming fundamentals, problem-solving, and practical Python skills applicable across backend development, data analysis, AI, automation, and scripting.",
        descriptionAr: "الدورة الأساسية في بايثون لجميع الطلاب، تغطي أساسيات البرمجة، وحل المشكلات، ومهارات بايثون العملية المستخدمة في تطوير الويب، تحليل البيانات، الذكاء الاصطناعي، الأتمتة والسكربتات.",
        overview: "Students learn Python basics, control flow, data structures, functions, OOP, and real-world applications. The course culminates in mini-projects and capstone exercises to prepare learners for advanced Python tracks.",
        overviewAr: "يتعلم الطلاب أساسيات بايثون، تدفق التحكم، هياكل البيانات، الدوال، البرمجة الكائنية، والتطبيقات العملية، وتنتهي الدورة بمشاريع صغيرة وتمارين شاملة لإعداد المتعلمين للمسارات المتقدمة.",
        level: "Beginner",
        levelAr: "مبتدئ",
        ...
        certification: "Certificate of Completion – Python for All",
        certificationAr: "شهادة إتمام دورة – بايثون للجميع",
        targetAudience: [
    ...
    },
    {
        ...
        description: "A foundational computer science course designed to build strong programming fundamentals, algorithmic thinking, and object-oriented design skills required for modern software development.",
        descriptionAr: "دورة تأسيسية في علوم الحاسب تهدف إلى بناء أساس قوي في البرمجة، التفكير الخوارزمي، ومبادئ البرمجة كائنية التوجه اللازمة لتطوير البرمجيات الحديثة.",
        overview: "This course introduces learners to the core principles of computer science and programming. Students develop problem-solving skills, understand how programs are structured, learn object-oriented programming, and apply fundamental data structures and algorithms. The course prepares learners for advanced tracks such as web development, mobile apps, data science, and software engineering.",
        overviewAr: "تقدم هذه الدورة المبادئ الأساسية لعلوم الحاسب والبرمجة، حيث يكتسب المتدرب مهارات حل المشكلات، وفهم بنية البرامج، وتعلم البرمجة كائنية التوجه، وتطبيق هياكل البيانات والخوارزميات الأساسية، مما يؤهله للانتقال إلى المسارات المتقدمة مثل تطوير الويب والموبايل وعلوم البيانات وهندسة البرمجيات.",
        level: "Beginner",
        levelAr: "مبتدئ",
    ...
    },
    {
        ...
        description: "A comprehensive, hands-on course covering PLC programming and industrial automation systems, from core electrical concepts to advanced SCADA, safety, and Industry 4.0 technologies.",
        descriptionAr: "دورة شاملة وتطبيقية تغطي برمجة المتحكمات المنطقية PLC وأنظمة الأتمتة الصناعية، بدءًا من الأساسيات الكهربائية وحتى أنظمة SCADA والسلامة الصناعية وتقنيات الثورة الصناعية الرابعة.",
        overview: "This course equips learners with practical and theoretical knowledge required to design, program, operate, and maintain modern industrial automation systems using PLCs, HMIs, SCADA, and industrial networks. It emphasizes real-world applications, troubleshooting, and industry best practices.",
        overviewAr: "تزود هذه الدورة المتدربين بالمعرفة النظرية والعملية اللازمة لتصميم وبرمجة وتشغيل وصيانة أنظمة الأتمتة الصناعية الحديثة باستخدام PLC وHMI وSCADA والشبكات الصناعية، مع التركيز على التطبيقات الواقعية وأفضل الممارسات الصناعية.",
        level: "Intermediate",
        levelAr: "متوسط",
...
const getCourseById = (id) => {
    return exports.courses.find(course => course.id === id);
};
exports.getCourseById = getCourseById;
const getCoursesByCategory = () => {
    return exports.courses.reduce((acc, course) => {
