...
exports.getPathProjectById = exports.getProjectsByPathId = exports.pathProjects = void 0;
exports.pathProjects = [
    {
        id: "path-cf-1",
...
const getProjectsByPathId = (pathId) => {
    return exports.pathProjects.filter(project => project.pathId === pathId).sort((a, b) => a.order - b.order);
};
exports.getProjectsByPathId = getProjectsByPathId;
const getPathProjectById = (id) => {
    return exports.pathProjects.find(project => project.id === id);
};
exports.getPathProjectById = getPathProjectById;
//# sourceMappingURL=pathProjects.js.map