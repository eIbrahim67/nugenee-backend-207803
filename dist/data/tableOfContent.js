...
exports.getCourseModuleLessonsById = exports.getTableOfContentsById = exports.getAllTablesOfContents = exports.tableOfContent = void 0;
    ...
    },
    {
        ...
        courseModules: [
            ...
            },
            {
                ...
                description: "Core concepts and structures of industrial automation systems.",
                descriptionAr: "المفاهيم الأساسية وبنية أنظمة الأتمتة الصناعية.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Electrical principles used in industrial control systems.",
                descriptionAr: "المبادئ الكهربائية المستخدمة في أنظمة التحكم الصناعية.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Understanding PLC hardware and operation principles.",
                descriptionAr: "فهم مكونات PLC ومبادئ التشغيل.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Introduction to ladder logic and basic PLC instructions.",
                descriptionAr: "مقدمة في مخططات السلم وتعليمات PLC الأساسية.",
                duration: "2 Weeks",
                durationAr: "أسبوعان",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Advanced logic, data handling, and diagnostics.",
                descriptionAr: "المنطق المتقدم ومعالجة البيانات والتشخيص.",
                duration: "2 Weeks",
                durationAr: "أسبوعان",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Design and integration of HMI systems.",
                descriptionAr: "تصميم وربط أنظمة HMI.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Industrial networking and PLC communication.",
                descriptionAr: "الشبكات الصناعية والاتصال بين PLC.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                descriptionAr: "أنظمة الإشراف وجمع البيانات.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Motor control principles and VFD integration.",
                descriptionAr: "مبادئ التحكم في المحركات وربط مغيرات السرعة.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Industrial sensors, signals, and calibration.",
                descriptionAr: "الحساسات الصناعية والإشارات والمعايرة.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Industrial safety concepts and standards.",
                descriptionAr: "مفاهيم ومعايير السلامة الصناعية.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Fault diagnosis and maintenance strategies.",
                descriptionAr: "تشخيص الأعطال واستراتيجيات الصيانة.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "End-to-end industrial automation projects.",
                descriptionAr: "مشاريع أتمتة صناعية متكاملة.",
                duration: "2 Weeks",
                durationAr: "أسبوعان",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Industry 4.0, IIoT, and future automation.",
                descriptionAr: "الصناعة 4.0 وإنترنت الأشياء الصناعي ومستقبل الأتمتة.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
        ...
        courseModules: [
            {
                ...
                description: "Understanding what computer science is and how software shapes the modern world.",
                descriptionAr: "فهم ماهية علوم الحاسوب ودور البرمجيات في العالم الحديث.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Developing computational thinking and algorithmic reasoning.",
                descriptionAr: "تطوير التفكير الحاسوبي والمنطقي.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Understanding programming language types and environments.",
                descriptionAr: "فهم أنواع لغات البرمجة وبيئات التطوير.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                titleAr: "المتغيرات وأنواع البيانات والعوامل",
                description: "Core building blocks of any programming language.",
                descriptionAr: "اللبنات الأساسية لأي لغة برمجة.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Using conditions and logic to control program behavior.",
                descriptionAr: "استخدام الشروط والمنطق للتحكم في سير البرنامج.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Repeating logic efficiently using loops.",
                descriptionAr: "تكرار الأوامر البرمجية بكفاءة.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Structuring programs using reusable logic.",
                descriptionAr: "تنظيم البرامج باستخدام منطق قابل لإعادة الاستخدام.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Writing clean, modular, and maintainable code.",
                descriptionAr: "كتابة كود منظم وقابل للصيانة.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Thinking in objects and classes.",
                descriptionAr: "التفكير باستخدام الكائنات والأصناف.",
                duration: "2 Weeks",
                durationAr: "أسبوعان",
                lessons: [
                    {
            ...
            },
            {
                ...
                descriptionAr: "التغليف والوراثة وتعدد الأشكال والتجريد.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Designing maintainable and scalable class structures.",
                descriptionAr: "تصميم هياكل أصناف قابلة للصيانة والتوسع.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Understanding data organization and memory.",
                descriptionAr: "فهم تنظيم البيانات والذاكرة.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                descriptionAr: "المصفوفات والقوائم والمكدسات والطوابير.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Foundations of trees, graphs, and hash tables.",
                descriptionAr: "أساسيات الأشجار والرسوم البيانية وجداول التجزئة.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                descriptionAr: "مقدمة في الخوارزميات والتعقيد.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                title: "Debugging Techniques",
                titleAr: "تقنيات تصحيح الأخطاء",
                description: "Identifying and fixing programming errors.",
                descriptionAr: "اكتشاف الأخطاء البرمجية ومعالجتها.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Ensuring correctness and maintainability.",
                descriptionAr: "ضمان صحة الكود وقابليته للصيانة.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Using Git for collaboration and versioning.",
                descriptionAr: "استخدام Git للتعاون وإدارة الإصدارات.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Developing strong problem-solving habits.",
                descriptionAr: "تطوير مهارات قوية في حل المشكلات.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Applying all learned concepts in a complete project.",
                descriptionAr: "تطبيق جميع المفاهيم المكتسبة في مشروع متكامل.",
                duration: "2 Weeks",
                durationAr: "أسبوعان",
                lessons: [
                    {
        ...
        courseModules: [
            {
                ...
                description: "Introducing kids to the idea of programming and creativity.",
                descriptionAr: "تعريف الأطفال بمفهوم البرمجة والإبداع.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Learning the Scratch interface and basic elements.",
                descriptionAr: "التعرف على واجهة سكراتش والعناصر الأساسية.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Moving characters and understanding directions.",
                descriptionAr: "تحريك الشخصيات وفهم الاتجاهات.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Making projects fun with visuals and audio.",
                descriptionAr: "جعل المشاريع ممتعة باستخدام الصور والأصوات.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Making projects interactive.",
                descriptionAr: "جعل المشاريع تفاعلية.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Understanding sequences, loops, and decisions.",
                descriptionAr: "فهم التسلسل والحلقات واتخاذ القرار.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Storing values like scores and timers.",
                descriptionAr: "تخزين القيم مثل النقاط والمؤقتات.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Planning and creating a simple game.",
                descriptionAr: "تخطيط وبناء لعبة بسيطة.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Adding levels, difficulty, and scoring.",
                descriptionAr: "إضافة مستويات وصعوبة ونقاط.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Combining storytelling with code.",
                descriptionAr: "دمج القصة مع البرمجة.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Polishing animations and synchronization.",
                descriptionAr: "تحسين الرسوم المتحركة وتزامنها.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Learning how to debug Scratch projects.",
                descriptionAr: "تعلم تصحيح أخطاء مشاريع سكراتش.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Thinking independently and improving projects.",
                descriptionAr: "التفكير المستقل وتحسين المشاريع.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                titleAr: "المشروع النهائي",
                description: "Building a complete creative Scratch project.",
                descriptionAr: "بناء مشروع سكراتش إبداعي متكامل.",
                duration: "2 Weeks",
                durationAr: "أسبوعان",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Presenting projects and celebrating achievements.",
                descriptionAr: "عرض المشاريع والاحتفال بالإنجازات.",
                duration: "1 Week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
        ...
        courseModules: [
            {
                ...
                description: "An introduction to robotics concepts and how hardware and software interact.",
                descriptionAr: "مقدمة في مفاهيم الروبوتات وكيفية تفاعل العتاد مع البرمجيات.",
                duration: "1 week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Learn Arduino basics, components, safety, and setup.",
                descriptionAr: "تعلم أساسيات أردوينو والمكونات وقواعد السلامة والإعداد.",
                duration: "1 week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Use Scratch to control Arduino hardware.",
                descriptionAr: "استخدام سكراش للتحكم في عتاد أردوينو.",
                duration: "1 week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Control LEDs, buzzers, and buttons using Scratch.",
                descriptionAr: "التحكم في المصابيح والأجراس والأزرار باستخدام سكراش.",
                duration: "1 week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Use sensors to read environmental data.",
                descriptionAr: "استخدام الحساسات لقراءة بيانات البيئة.",
                duration: "2 weeks",
                durationAr: "أسبوعان",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Apply conditions, loops, and events in robotics.",
                descriptionAr: "تطبيق الشروط والحلقات والأحداث في الروبوتات.",
                duration: "1 week",
                durationAr: "أسبوع واحد",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Learn how robots move using motors.",
                descriptionAr: "تعلم كيفية حركة الروبوتات باستخدام المحركات.",
                duration: "2 weeks",
                durationAr: "أسبوعان",
                lessons: [
                    {
            ...
            },
            {
                ...
                description: "Design and build a complete robotic system.",
                descriptionAr: "تصميم وبناء نظام روبوت متكامل.",
                duration: "3 weeks",
                durationAr: "3 أسابيع",
                lessons: [
                    {
...
const getAllTablesOfContents = () => {
    return exports.tableOfContent;
};
exports.getAllTablesOfContents = getAllTablesOfContents;
const getTableOfContentsById = (id) => {
    return exports.tableOfContent.find(toc => toc.id === id);
};
exports.getTableOfContentsById = getTableOfContentsById;
const getCourseModuleLessonsById = (id) => {
    const toc = exports.tableOfContent.find(toc => toc.id === id);
    if (!toc)
        return [];
...
exports.getCourseModuleLessonsById = getCourseModuleLessonsById;
